...
<div class="three">
    <div id="tabs">
        <ul>
            <li><a href="#tabs-1" >View Dignosis Data</a></li>
            <li><a href="#tabs-2" >Add New Dignosis</a></li>
        </ul> 
    <div id="tabs-1">
    		<?php
			$Infodata=$this->org_model->get_diagnosis_field($this->session->userdata['id']);
            ...
            <td width="50%" align="center">Dignosis name</td>
            ...
            <td align="center"><input class="checkbox1" type="checkbox" name="check[]" value="<?php echo $v->diagnosis_id;?>"></td>
            </tr>
