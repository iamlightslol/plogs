...
<div class="three">
    <div id="tabs">
        <ul>
            <li><a href="#tabs-1" >View Rotation Data</a></li>
            <li><a href="#tabs-2" >Add New Rotation</a></li>
        </ul> 
    <div id="tabs-1">
    		<?php
            ...
            <td width="50%" align="center">Rotation Name</td>
            ...
            <td align="center"><input class="checkbox1" type="checkbox" name="check[]" value="<?php echo $v->rotation_id;?>"></td>
            </tr>
    ...
    <div id="tabs-2">
       ...
       <?php echo form_open("dashboard/addrotation");?> 
        ...
        <div id="address">
        <div class="ld"><input type="text"  name="rotation[]" required placeholder="Rotation"/></div>
        </div>
